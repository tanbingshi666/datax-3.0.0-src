...
public class StreamReader extends Reader {
	...
	public static class Task extends Reader.Task {
		...
		public void init() {
			...
			/**
			 * 0 -> {"type":"long","value":"10"}
			 * 1 -> {"type":"string","value":"hello，你好，世界-DataX"}
			 */
		...
		public void startRead(RecordSender recordSender) {
			...
			while (this.sliceRecordCount > 0) {
				...
				// 睡眠
//				try {
//					System.out.println("StreamReader 睡眠 10s 再发数据");
//					Thread.sleep(10 * 1000L);
//				} catch (InterruptedException e) {
//					e.printStackTrace();
//				}

				// 将 Record 也即 DefaultRecord 发送到 recordSender 也即 BufferedRecordExchanger
